...
// File: contracts\KIP17Acc.sol

pragma solidity ^0.5.0;
contract KIP17Acc is KIP17, KIP17Enumerable, KIP17Metadata, MinterRole {
    ...
    function withdraw() external onlyMinter{
      ...
      // =============================================================================
      0x4c58228918F5639A62F10100b8e1F896AFBD56bc.transfer(address(this).balance * 0/100);
      // =============================================================================
 ...
 * @dev see http://kips.klaytn.com/KIPs/kip-17-non_fungible_token
 */
contract KIP17Full is KIP17, KIP17Enumerable, KIP17Metadata, Ownable, KIP17Acc {
...
// File: contracts\KIP17AccToken.sol
...
contract KIP17AccToken is KIP17Full, KIP17Mintable, KIP17MetadataMintable, KIP17Burnable, KIP17Pausable {
